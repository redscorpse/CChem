" Vim Color File
" Name:       myTheme.vim
" Modified_from: https://github.com/exitface/myTheme.vim
...
if !exists("g:myTheme_terminal_italics")
  let g:myTheme_terminal_italics = 0
endif
...
function! s:h(group, style)
  if g:myTheme_terminal_italics == 0
...
function! myTheme#set_highlight(group, style)
...
let s:black = { "gui": "#101c28", "cterm": "53" }
